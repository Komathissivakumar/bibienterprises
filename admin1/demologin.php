...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["uname1	"]))){
        $uname1_err = "Please enter username.";
    } else{
    ...
    if(empty($uname1_err) && empty($upswd1_err)){
        // Prepare a select statement
        $sql = "SELECT id, uname1, upswd1 FROM register WHERE uname1 = ?";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    mysqli_stmt_bind_result($stmt, $id, $uname1, $hashed_upswd1);
                    ...
                    $username_err = "No account found with that 	uname1.";
                }
            } else{
...
<body>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Don't have an account? <a href="demoreg.php">Sign up now</a>.</p>
        </form>
    </div>    
</body>
</html>