...
$query = "SELECT * FROM product LIMIT 4 OFFSET 4 ";
...
if(mysqli_num_rows($query_run) > 0)
{
	while($row=mysqli_fetch_assoc($query_run))
	{
		?>
		  ...
		  <div class="col-sm-3">
		  <h4 class="card-title">Special Offer:  <?php echo $row['product_offer']; ?> </h4>
                            <div class="col-item">
                                ...
                                <div class="info">
                                    ...
                                    <div class="row_1" >
                                        <div class="price col-sm-12" style="height:100px">
                                           <h4>Brand name:<?php echo $row['brand_name']; ?> </h4>
...
<h4>Product price: <?php echo $row['product_price']; ?> </h4>
      ...
      <div class="modal-footer">
        ...
        <!--<button type="button" class="btn btn-primary">Save changes</button>-->
                                       ...
                                       <div> <a href="allproduct.php" ><button type="button" class="btn btn-primary">Explore All Products</button></a></div>
                                    </div>
